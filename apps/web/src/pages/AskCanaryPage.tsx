    ...
    <div className="space-y-5">
      <header>
        ...
        <p className="mt-1 max-w-2xl text-sm leading-relaxed text-neutral-500">
          Use the yellow <span className="font-medium text-neutral-800">Ask a question</span> button
          in the bottom-right corner. Same tools as iMessage. Spoken figures come from a tool result
          in this conversation; exact amounts stay on the incident page. Answers follow OBSERVED →
          DETECTED → EVIDENCE → ESTIMATE → SUGGESTION. Suggestions are never operational orders.
        </p>
